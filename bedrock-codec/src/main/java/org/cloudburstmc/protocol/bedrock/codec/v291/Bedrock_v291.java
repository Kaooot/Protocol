...
public class Bedrock_v291 {
    ...
    protected static final TypeMap<ActorFlag> ENTITY_FLAGS = TypeMap.builder(ActorFlag.class)
            .insert(0, ActorFlag.ON_FIRE)
            .insert(1, ActorFlag.SNEAKING)
            .insert(2, ActorFlag.RIDING)
            .insert(3, ActorFlag.SPRINTING)
            .insert(4, ActorFlag.USING_ITEM)
            .insert(5, ActorFlag.INVISIBLE)
            .insert(6, ActorFlag.TEMPTED)
            .insert(7, ActorFlag.IN_LOVE)
            .insert(8, ActorFlag.SADDLED)
            .insert(9, ActorFlag.POWERED)
            .insert(10, ActorFlag.IGNITED)
            .insert(11, ActorFlag.BABY)
            .insert(12, ActorFlag.CONVERTING)
            .insert(13, ActorFlag.CRITICAL)
            .insert(14, ActorFlag.CAN_SHOW_NAME)
            .insert(15, ActorFlag.ALWAYS_SHOW_NAME)
            .insert(16, ActorFlag.NO_AI)
            .insert(17, ActorFlag.SILENT)
            .insert(18, ActorFlag.WALL_CLIMBING)
            .insert(19, ActorFlag.CAN_CLIMB)
            .insert(20, ActorFlag.CAN_SWIM)
            .insert(21, ActorFlag.CAN_FLY)
            .insert(22, ActorFlag.CAN_WALK)
            .insert(23, ActorFlag.RESTING)
            .insert(24, ActorFlag.SITTING)
            .insert(25, ActorFlag.ANGRY)
            .insert(26, ActorFlag.INTERESTED)
            .insert(27, ActorFlag.CHARGED)
            .insert(28, ActorFlag.TAMED)
            .insert(29, ActorFlag.ORPHANED)
            .insert(30, ActorFlag.LEASHED)
            .insert(31, ActorFlag.SHEARED)
            .insert(32, ActorFlag.GLIDING)
            .insert(33, ActorFlag.ELDER)
            .insert(34, ActorFlag.MOVING)
            .insert(35, ActorFlag.BREATHING)
            .insert(36, ActorFlag.CHESTED)
            .insert(37, ActorFlag.STACKABLE)
            .insert(38, ActorFlag.SHOW_BOTTOM)
            .insert(39, ActorFlag.STANDING)
            .insert(40, ActorFlag.SHAKING)
            .insert(41, ActorFlag.IDLING)
            .insert(42, ActorFlag.CASTING)
            .insert(43, ActorFlag.CHARGING)
            .insert(44, ActorFlag.WASD_CONTROLLED)
            .insert(45, ActorFlag.CAN_POWER_JUMP)
            .insert(46, ActorFlag.LINGERING)
            .insert(47, ActorFlag.HAS_COLLISION)
            .insert(48, ActorFlag.HAS_GRAVITY)
            .insert(49, ActorFlag.FIRE_IMMUNE)
            .insert(50, ActorFlag.DANCING)
            .insert(51, ActorFlag.ENCHANTED)
            .insert(52, ActorFlag.RETURN_TRIDENT)
            .insert(53, ActorFlag.CONTAINER_IS_PRIVATE)
            .insert(54, ActorFlag.IS_TRANSFORMING)
            .insert(55, ActorFlag.DAMAGE_NEARBY_MOBS)
            .insert(56, ActorFlag.SWIMMING)
            .insert(57, ActorFlag.BRIBED)
            .insert(58, ActorFlag.IS_PREGNANT)
            .insert(59, ActorFlag.LAYING_EGG)
            .insert(60, ActorFlag.RIDER_CAN_PICK)
            .build();
    ...
    protected static final ActorDataTypeMap ENTITY_DATA = ActorDataTypeMap.builder()
            .insert(ActorDataTypes.FLAGS, 0, ActorDataFormat.LONG, new FlagTransformer(ENTITY_FLAGS, 0))
    ...
    protected static final TypeMap<ActorEventType> ENTITY_EVENTS = TypeMap.builder(ActorEventType.class)
            .insert(0, ActorEventType.NONE)
            .insert(1, ActorEventType.JUMP)
            .insert(2, ActorEventType.HURT)
            .insert(3, ActorEventType.DEATH)
            .insert(4, ActorEventType.ATTACK_START)
            .insert(5, ActorEventType.ATTACK_STOP)
            .insert(6, ActorEventType.TAME_FAILED)
            .insert(7, ActorEventType.TAME_SUCCEEDED)
            .insert(8, ActorEventType.SHAKE_WETNESS)
            .insert(9, ActorEventType.USE_ITEM)
            .insert(10, ActorEventType.EAT_GRASS)
            .insert(11, ActorEventType.FISH_HOOK_BUBBLE)
            .insert(12, ActorEventType.FISH_HOOK_POSITION)
            .insert(13, ActorEventType.FISH_HOOK_TIME)
            .insert(14, ActorEventType.FISH_HOOK_TEASE)
            .insert(15, ActorEventType.SQUID_FLEEING)
            .insert(16, ActorEventType.ZOMBIE_VILLAGER_CURE)
            .insert(17, ActorEventType.PLAY_AMBIENT)
            .insert(18, ActorEventType.RESPAWN)
            .insert(19, ActorEventType.GOLEM_FLOWER_OFFER)
            .insert(20, ActorEventType.GOLEM_FLOWER_WITHDRAW)
            .insert(21, ActorEventType.LOVE_PARTICLES)
            .insert(22, ActorEventType.VILLAGER_ANGRY)
            .insert(23, ActorEventType.VILLAGER_HAPPY)
            .insert(24, ActorEventType.WITCH_HAT_MAGIC)
            .insert(25, ActorEventType.FIREWORK_EXPLODE)
            .insert(26, ActorEventType.IN_LOVE_HEARTS)
            .insert(27, ActorEventType.SILVERFISH_MERGE_WITH_STONE)
            .insert(28, ActorEventType.GUARDIAN_ATTACK_ANIMATION)
            .insert(29, ActorEventType.WITCH_DRINK_POTION)
            .insert(30, ActorEventType.WITCH_THROW_POTION)
            .insert(31, ActorEventType.PRIME_TNT_MINECART)
            .insert(32, ActorEventType.PRIME_CREEPER)
            .insert(33, ActorEventType.AIR_SUPPLY)
            .insert(34, ActorEventType.PLAYER_ADD_XP_LEVELS)
            .insert(35, ActorEventType.ELDER_GUARDIAN_CURSE)
            .insert(36, ActorEventType.AGENT_ARM_SWING)
            .insert(37, ActorEventType.ENDER_DRAGON_DEATH)
            .insert(38, ActorEventType.DUST_PARTICLES)
            .insert(39, ActorEventType.ARROW_SHAKE)
            // gap
            .insert(57, ActorEventType.EATING_ITEM)
            .insert(60, ActorEventType.BABY_ANIMAL_FEED)
            .insert(61, ActorEventType.DEATH_SMOKE_CLOUD)
            .insert(62, ActorEventType.COMPLETE_TRADE)
            .insert(63, ActorEventType.REMOVE_LEASH)
            .insert(64, ActorEventType.CARAVAN)
            .insert(65, ActorEventType.CONSUME_TOTEM)
            .insert(66, ActorEventType.CHECK_TREASURE_HUNTER_ACHIEVEMENT)
            .insert(67, ActorEventType.ENTITY_SPAWN)
            .insert(68, ActorEventType.DRAGON_FLAMING)
            .insert(69, ActorEventType.UPDATE_ITEM_STACK_SIZE)
            .insert(70, ActorEventType.START_SWIMMING)
            .insert(71, ActorEventType.BALLOON_POP)
            .insert(72, ActorEventType.TREASURE_HUNT)
            .build();
    ...
    public static final BedrockCodec CODEC = BedrockCodec.builder()
            ...
            .registerPacket(ActorEventPacket::new, new ActorEventSerializer_v291(ENTITY_EVENTS), 27, PacketRecipient.BOTH)
