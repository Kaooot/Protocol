...
public class Bedrock_v291 {
    ...
    protected static final TypeMap<ActorEvent> ACTOR_EVENTS = TypeMap.builder(ActorEvent.class)
            ...
            .insert(4, ActorEvent.ATTACK_START)
            .insert(5, ActorEvent.ATTACK_STOP)
            .insert(6, ActorEvent.TAME_FAILED)
            .insert(7, ActorEvent.TAME_SUCCEEDED)
            .insert(8, ActorEvent.SHAKE_WETNESS)
            .insert(9, ActorEvent.USE_ITEM)
            .insert(10, ActorEvent.EAT_GRASS)
            .insert(11, ActorEvent.FISH_HOOK_BUBBLE)
            .insert(12, ActorEvent.FISH_HOOK_POSITION)
            .insert(13, ActorEvent.FISH_HOOK_TIME)
            .insert(14, ActorEvent.FISH_HOOK_TEASE)
            .insert(15, ActorEvent.SQUID_FLEEING)
            .insert(16, ActorEvent.ZOMBIE_VILLAGER_CURE)
            .insert(17, ActorEvent.PLAY_AMBIENT)
            .insert(18, ActorEvent.RESPAWN)
            .insert(19, ActorEvent.GOLEM_FLOWER_OFFER)
            .insert(20, ActorEvent.GOLEM_FLOWER_WITHDRAW)
            .insert(21, ActorEvent.LOVE_PARTICLES)
            .insert(22, ActorEvent.VILLAGER_ANGRY)
            .insert(23, ActorEvent.VILLAGER_HAPPY)
            .insert(24, ActorEvent.WITCH_HAT_MAGIC)
            .insert(25, ActorEvent.FIREWORK_EXPLODE)
            .insert(26, ActorEvent.IN_LOVE_HEARTS)
            .insert(27, ActorEvent.SILVERFISH_MERGE_WITH_STONE)
            .insert(28, ActorEvent.GUARDIAN_ATTACK_ANIMATION)
            .insert(29, ActorEvent.WITCH_DRINK_POTION)
            .insert(30, ActorEvent.WITCH_THROW_POTION)
            .insert(31, ActorEvent.PRIME_TNT_MINECART)
            .insert(32, ActorEvent.PRIME_CREEPER)
            .insert(33, ActorEvent.AIR_SUPPLY)
            .insert(34, ActorEvent.PLAYER_ADD_XP_LEVELS)
            .insert(35, ActorEvent.ELDER_GUARDIAN_CURSE)
            .insert(36, ActorEvent.AGENT_ARM_SWING)
            .insert(37, ActorEvent.ENDER_DRAGON_DEATH)
            .insert(38, ActorEvent.DUST_PARTICLES)
            .insert(39, ActorEvent.ARROW_SHAKE)
            // gap
            .insert(57, ActorEvent.EATING_ITEM)
            .insert(60, ActorEvent.BABY_ANIMAL_FEED)
            .insert(61, ActorEvent.DEATH_SMOKE_CLOUD)
            .insert(62, ActorEvent.COMPLETE_TRADE)
            .insert(63, ActorEvent.REMOVE_LEASH)
            .insert(64, ActorEvent.CARAVAN)
            .insert(65, ActorEvent.CONSUME_TOTEM)
            .insert(66, ActorEvent.CHECK_TREASURE_HUNTER_ACHIEVEMENT)
            .insert(67, ActorEvent.ENTITY_SPAWN)
            .insert(68, ActorEvent.DRAGON_FLAMING)
            .insert(69, ActorEvent.UPDATE_ITEM_STACK_SIZE)
