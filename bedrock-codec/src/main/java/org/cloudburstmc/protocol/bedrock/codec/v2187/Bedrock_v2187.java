...
public class Bedrock_v2187 extends Bedrock_v2168 {
    ...
    public static final BedrockCodec CODEC = Bedrock_v2168.CODEC.toBuilder()
            ...
            .helper(() -> new BedrockCodecHelper_v2187(ACTOR_DATA, GAME_RULE_TYPES, ITEM_STACK_REQUEST_TYPES, CONTAINER_SLOT_TYPES, PLAYER_ABILITIES, TEXT_PROCESSING_ORIGINS))
            ...
            .updateSerializer(InventoryTransactionPacket.class, InventoryTransactionSerializer_v2187.INSTANCE)
            .updateSerializer(ItemStackResponsePacket.class, ItemStackResponseSerializer_v2187.INSTANCE)
            ...
            .updateSerializer(SubChunkPacket.class, SubChunkSerializer_v2187.INSTANCE)
