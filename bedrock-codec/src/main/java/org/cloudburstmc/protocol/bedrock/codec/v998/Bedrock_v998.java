package org.cloudburstmc.protocol.bedrock.codec.v998;
 ...
 * @author Kaooot
 */
public class Bedrock_v998 extends Bedrock_v975 {
    ...
    public static final BedrockCodec CODEC = Bedrock_v975.CODEC.toBuilder()
            ...
            .helper(() -> new BedrockCodecHelper_v998(ACTOR_DATA, GAME_RULE_TYPES, ITEM_STACK_REQUEST_TYPES, CONTAINER_SLOT_TYPES, PLAYER_ABILITIES, TEXT_PROCESSING_ORIGINS))
            ...
            .updateSerializer(ServerPresenceInfoPacket.class, ServerPresenceInfoSerializer_v998.INSTANCE)
            .updateSerializer(StartGamePacket.class, StartGameSerializer_v998.INSTANCE)
            .updateSerializer(SubChunkRequestPacket.class, SubChunkRequestSerializer_v998.INSTANCE)
            .registerPacket(ClientboundUpdateSoundDataPacket::new, ClientboundUpdateSoundSerializer_v998.INSTANCE, 348, PacketRecipient.CLIENT)
            .registerPacket(SendPartyDestinationCookiePacket::new, SendPartyDestinationCookieSerializer_v998.INSTANCE, 349, PacketRecipient.SERVER)
            .registerPacket(PartyDestinationCookieResponsePacket::new, PartyDestinationCookieResponseSerializer_v998.INSTANCE, 350, PacketRecipient.CLIENT)
            .build();
}